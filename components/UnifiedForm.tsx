...
export function UnifiedForm({ initialData, onSubmit, isFreeGenerate = false }: UnifiedFormProps) {
  const [businesses, setBusinesses] = useState(['外卖', '医药', '美食', '酒店', '电商']);
  const [sizes, setSizes] = useState(['低尺寸(750x450)', '中尺寸(1080x1920)', '高尺寸(1920x1080)']);
  ...
  const [formData, setFormData] = useState<UnifiedFormData>({
    ...
    size: initialData?.size || '中尺寸(1080x1920)',
